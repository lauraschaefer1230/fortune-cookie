...
# we want the MainHandler class to inherit from the RequestHandler library


app = webapp2.WSGIApplication([
    ('/', MainHandler)
], debug=True)
#Routes are the list within the above statement('/', MainHandler), ('/login', LoginHandler)
#app is an instance of webapp2...  we're calling the constructor webapp2.... by calling the app
